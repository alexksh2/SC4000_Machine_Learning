...
output_dir = (
    f"/home/samic_yongjian/temp/SC4000_Machine_Learning/output/cnn/{timestamp}/"
)
...
class CNN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = nn.Linear(
            in_features=32 * 30 * 30, out_features=128
        )  # Adjust input size accordingly
        self.fc2 = nn.Linear(
            in_features=128, out_features=num_classes
        )  # Output layer now has num_classes units
