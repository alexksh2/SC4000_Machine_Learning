...
output_dir = f"/home/samic_yongjian/temp/SC4000_Machine_Learning/output/ensemble_lightgbm_l2/{timestamp}/"
os.makedirs(output_dir, exist_ok=True)

logging.basicConfig(
    filename=os.path.join(output_dir, "ensemble_lightgbm_l2.log"),
    filemode="w",
...
joblib.dump(gbm, os.path.join(output_dir, "ensemble_lightgbm_model_l2.pkl"))
