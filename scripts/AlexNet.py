...
output_dir = f"/home/samic_yongjian/temp/SC4000_Machine_Learning/output/alexnet/{timestamp}/"
...
class AlexNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = nn.Linear(
            in_features=2304, out_features=4096
        )  # Adjust input size as per final conv layer output
